...
- 大きめの変更に入る前に、何をどう変えるかを一度要約してから着手する
...
1. **`README.md` の技術スタック表に載っているか確認**
2. 載っていない場合は **一度立ち止まって要否を検討する**
...
## 8. レビューポイント (変更を入れる前の自分用チェックリスト)

- [ ] 依頼された範囲に収まっているか?
- [ ] 既存の設計方針・ADR と矛盾していないか?
- [ ] 依存方向ルールを守っているか?
